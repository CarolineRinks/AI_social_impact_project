...
This research was conducted as part of a term project for the Spring 2024 AI for Social Impact class at Vanderbilt University.

## Citation

```bibtex
@inproceedings{rinks2025enhancing,
  title={Enhancing Detection of Relationship Abuse in Text with Multi-task Learning (Student Abstract)},
  author={Rinks, Caroline},
